<?php
    ...
    $HeadCheck = 'Dependency';
    $_SESSION['Link'] = 'Dependency.php';
    // echo $_SESSION['SuperSite'];
...
<script type="text/javascript">
    $(document).ready(function() {
		$('.SubmitData').click(function(){
            swal({
                ...
                window.location='Dependency.php';
            });
        });
    ...
    $('.open-sendname').click(function(event) {
        ...
        var site = $(this).data('a');
        var sites = $(this).data('c');
        var id = $(this).data('b');

        $('#Group_Names').val(name);
        $('#Group_IDs').val(id);

        div = document.getElementById('Site_IDs');
        div.innerHTML = '';
        div.add(new Option(sites, site));
    });
</script>
<script>
