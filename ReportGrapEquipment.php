<?php
    ...
    $HeadCheck = 'GrapEquipment';
    $_SESSION['Link'] = 'ReportGrapEquipment.php';
?>
                            ...
                            <div id="graph2" style="display: none;">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        ...
                                        <div class="col-sm-2">
                                            <h5>
                                                รายการเบิก : <div type="" id="Text2" style="color: #a3e1d4;"></div>
                                            </h5>
                                        </div>
                                        <div class="col-sm-2">
                                            <h5>
                                                รายการจ่าย : <div type="" id="Text3" style="color: #dedede;"></div>
                                            </h5>
                                        </div>
...
<script type="text/javascript">
    ...
    function showGrap() {
        ...
        travflex.compulsory.Criteria['mode'] = 'load_grap_price_list';
